                ...
                <div className={styles['OutWrapper']}>
                    <div className='flex flex-col gap-y-2 mt-12'>
                        ...
                        <button className={styles['yahoo-button']} onClick={() => openPopup('yahoo')}>
                            <div className='h-full rounded-md ml-1 mt-1'>
                                <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} aria-label="Yahoo!" role="img" viewBox="0 0 512 512" fill="#000000">
            ...
            {showPopup && (
                <div className={styles['popup-overlay']}>
                    <div className={styles['popup']}>
                        <button className={styles['close-button']} onClick={closePopup}>×</button>
