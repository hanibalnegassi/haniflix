            ...
            <div className={addClassNames(styles["loginNew"])}>
                ...
                <div className="container p-2 mt-2" id="termsServicePage">
                    ...
                    <div className="text-lg">
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">Cookies</h4>
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">Hyperlinking to our Content</h4>
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">iFrames</h4>
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">Content Liability</h4>
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">Reservation of Rights</h4>
                        <p>We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it's linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions. </p>

                        <h4 className="font-bold text-2xl mt-3 uppercase">Removal of links from our website</h4>
                        ...
                        <h4 className="font-bold text-2xl mt-3 uppercase">Disclaimer</h4>
